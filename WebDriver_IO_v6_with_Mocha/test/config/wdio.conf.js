...
//$env:DEFAULT_TIMEOUT="someValue"
//$env:URL_UNDER_TEST="someValue"
...
console.log("URL under test is:", URL_UNDER_TEST);
...
exports.config = {
  ...
  // directory is where your package.json residsetes, so `wdio` will be called from there.
  //
  specs: ["./test/basics/*.js"],
  // Patterns to exclude.
  exclude: [
  ...
  //
  capabilities: require("./browserCapabilities"),
  //
  // ===================
  // Test Configurations
  // ===================
  ...
  // services: ["selenium-standalone"],s
  ...
  beforeSession: function (config, capabilities, specs) {
    ...
    del(['errorShots', 'reports', 'allure-reports']);
  },
  /**
  ...
  before: function (capabilities, specs) {
    ...
    browser.addCommand("getPageTitleCustom", function (element) {
